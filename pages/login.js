...
export default function LoginPage() {
  ...
  return (
    <div className="container my-4">
      <h2 className="text-center mb-4">Gura NotesKeeper <i class="bi bi-journal-check"></i></h2>
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          <form onSubmit={handleLoginUser}>
            ...
            <button className="btn btn-outline-primary rounded-0" disabled={loading}>Login</button>
            </div>
          </form>
